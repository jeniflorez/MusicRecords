  ...
  <body style="background-color:#000">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <ul class="nav">
          <li><a href="" style="margin-top: -13px; margin-left: 143px;">INFORMES</a>
            <ul>
        ...
        <img  src="../src/discos3.png"  width="140" height="140" style="margin-left: 315px; margin-top: 139px;">
           <center><h1 style="margin-right: -155px; margin-top: -86px;width: 1163px">VENTAS PERSONALES</h1></center>
             <table class="table table-responsive" style="margin-top: -36px; margin-left: 137px;">
             <thead><tr><th>Cliente</th><th>Disco</th><th>Valor</th><th>Estado</th></tr></thead><tbody>
 						<?php
 							require_once('Conexion.php');

                  $Cod_cliente = $_GET['codigo'];
                  $sql = "SELECT * FROM ventas_personales";
                  $result = mysqli_query($Conexion,$sql);
                        ...
                        if($estadoVenta==1){
                           ...
                           $estadoVenta='NO VENDIDO';
                        }
                        $t.='<tr><td>'.$NomCliente.'</td><td>'.$NomDisco.'</td><td>'.$fila1['valor'].'</td><td>'.$estadoVenta.'</td></tr>';
 											}
 											$t.='</tbody>';
 											$t.='</table>';
                      print $t;
