  ...
  <body style="background-color:#000">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <ul class="nav">
          <li><a href="" style="margin-top: -16px; margin-left: 143px;">INFORMES</a>
            <ul>
        ...
        <img  src="../src/discos4.png"  width="140" height="140" style="margin-left: 253px; margin-top: 139px;">
           <center><h1 style="margin-right: -155px; margin-top: -86px;width: 1163px">TOP DISCOS MÁS VENDIDOS</h1></center>
             <table class="table table-responsive" style="margin-top: -36px; margin-left: 137px;">
             <thead><tr><th>Nombre disco</th><th>Ventas</th></tr></thead><tbody>
 						<?php
 							require_once('Conexion.php');

                  $sql = "SELECT cod_disco,count(cod_disco) as cantidad FROM ventas GROUP BY cod_disco";
                  $result = mysqli_query($Conexion,$sql);
                        ...
                        $t.='<tr><td>'.$fila2['nombre'].'</td><td>'.$fila1['cantidad'].'</td></tr>';
 											}
 											$t.='</tbody>';
 											$t.='</table>';
                      print $t;
