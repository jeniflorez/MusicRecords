  ...
  <body style="background-color:#000">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <ul class="nav">
          <li><a href="" style="margin-top: -19px; margin-left: 143px;">INFORMES</a>
            <ul>
        ...
        <img  src="../src/discos5.png"  width="140" height="140" style="margin-left: 382px; margin-top: 139px;">
           <center><h1 style="margin-right: -155px; margin-top: -86px;width: 1163px">TOP CLIENTES</h1></center>
             <table class="table table-responsive" style="margin-top: -36px; margin-left: 137px;">
             <thead><tr><th>Cliente</th><th>Compras</th></tr></thead><tbody>
 						<?php
 							require_once('Conexion.php');

              $sql = "SELECT cod_cliente,count(cod_cliente) as cantidad FROM ventas GROUP BY cod_cliente";
              ...
              while ($fila1 = mysqli_fetch_assoc($result)) {
                  ...
                  $t.='<tr><td>'.$fila2['nombre'].' '.$fila2['apellidos'].'</td><td>'.$fila1['cantidad'].'</td></tr>';
                  }
 							$t.='</tbody>';
 							$t.='</table>';
              print $t;
