    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <?php
          $Cod_cliente=$_GET['codigo'];
          if($Cod_cliente==""){
            $html='<a href="CatalogoU1.php"><h2 style="margin-left: 488px; color: #fff; margin-top: 39px;">Discos Usuarios</h2></a>';
          }else{
            $html='<a href="CatalogoU1.php?codigo='.$Cod_cliente.'"><h2 style="margin-left: 488px; color: #fff; margin-top: 39px;">Discos Usuarios</h2></a>';
          }
          print $html;
         ?>
        ...
        $sql = "SELECT * FROM discos;";
         ...
         while ($row_tb=mysqli_fetch_assoc($rs)) {
           ...
           $Var.= '<h2>'.$Nombre.'</h2>';
           $Var.= '<h2>'.$Artista.'</h2>';
           $Var.= '<p><a class="btn btn-default" href="Detalle.php?Codigo='.$Codigo.'&codigo='.$Cod_cliente.'&tipo=1" role="button">Ver Información&raquo;</a></p>';
           $Var.= '</div><!-- /.col-lg-4 -->';
           print $Var;
         }
